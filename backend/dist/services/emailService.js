...
exports.getEmailStats = exports.createCampaign = exports.sendBulk = exports.sendAsClient = exports.sendEmail = exports.emailService = void 0;
...
// Initialize Supabase
const supabase = (0, supabase_js_1.createClient)(process.env.SUPABASE_URL, process.env.SUPABASE_ANON_KEY || process.env.SUPABASE_SERVICE_ROLE_KEY);
class EmailOrchestrator {
    ...
    initializePostal() {
        ...
        if (postalHost && postalApiKey) {
            try {
                this.postalTransporter = (0, nodemailer_1.createTransport)({
                    host: postalHost,
    ...
    async sendEmail(options) {
        const { from, to, subject, html, text, replyTo, headers = {}, attachments = [], usePostal = false } = options;
        try {
...
exports.emailService = new EmailOrchestrator();
// Export convenience functions
const sendEmail = (options) => exports.emailService.sendEmail(options);
exports.sendEmail = sendEmail;
const sendAsClient = (clientEmail, clientName, recipientEmail, subject, body) => exports.emailService.sendAsClient(clientEmail, clientName, recipientEmail, subject, body);
exports.sendAsClient = sendAsClient;
const sendBulk = (emails, delayBetween) => exports.emailService.sendBulk(emails, delayBetween);
exports.sendBulk = sendBulk;
const createCampaign = (name, recipients, subject, htmlTemplate, schedule) => exports.emailService.createCampaign(name, recipients, subject, htmlTemplate, schedule);
exports.createCampaign = createCampaign;
const getEmailStats = () => exports.emailService.getStats();
