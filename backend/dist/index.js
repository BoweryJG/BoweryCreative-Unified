...
const client_emails_js_1 = __importDefault(require("./routes/client-emails.js"));
...
// Email routes
app.use('/api/emails', email_js_1.default);
...
app.use('/api/client-emails', client_emails_js_1.default);
...
app.get('/api/contacts', authenticateAPI, async (req, res) => {
    try {
        ...
        if (leadScoreMin)
            query = query.gte('lead_score', leadScoreMin);
        if (assignedTo)
