...
async function sendToCorrectEmail() {
  console.log('Sending invoice email to Dr. Greg Pedro at gcpedro2018@gmail.com...');
  ...
  if (data.success) {
    console.log('✅ Invoice email successfully sent to gcpedro2018@gmail.com');
  }
}
